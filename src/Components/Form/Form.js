...
export default class Form extends Component {
  ...
  state = {
    first:
      (this.props.defaultVals && this.props.defaultVals.report_first) ||
      undefined,
    last:
      (this.props.defaultVals && this.props.defaultVals.report_last) ||
      undefined,
    email:
      (this.props.defaultVals && this.props.defaultVals.report_email) ||
      undefined,
    phone:
      (this.props.defaultVals && this.props.defaultVals.report_phone) ||
      undefined,
    lat:
      (this.props.defaultVals && this.props.defaultVals.report_lat) ||
      undefined,
    lng:
      (this.props.defaultVals && this.props.defaultVals.report_lng) ||
      undefined,
    type:
      (this.props.defaultVals &&
        populateType(this.props.defaultVals.report_type)) ||
      [],
    waterBody:
      (this.props.defaultVals && this.props.defaultVals.report_waterbody) ||
      undefined,
    details:
      (this.props.defaultVals && this.props.defaultVals.report_details) ||
      undefined,
    date:
      (this.props.defaultVals && this.props.defaultVals.report_date) ||
      undefined,
    time:
      (this.props.defaultVals && this.props.defaultVals.report_time) ||
      undefined,
    other:
      (this.props.defaultVals && this.props.defaultVals.report_other) ||
      undefined,
    error: undefined,
  };
  ...
  handleUpdateReport = (e) => {
    e.preventDefault();
    this.context
      .handleEditReport(this.props.defaultVals.id, {
  ...
  handleFirstName = (e) => {
    if (e.target.value === "")
      this.setState({ first: e.target.value, error: "first name missing" });
    else {
  ...
  handleLastName = (e) => {
    if (e.target.value === "")
      this.setState({ last: e.target.value, error: "last name missing" });
    else {
  ...
  handleEmail = (e) => {
    if (e.target.value === "")
      this.setState({ email: e.target.value, error: "email missing" });
    else {
      ...
      <>
        ...
        {!!this.state.subRec ? (
          ...
          <section className={"form-section"}>
            <form className={"react-form"} onSubmit={this.handlePostReport}>
              ...
              />
              <MapComponent
                updateLatLng={(lat, lng) => this.handleLatLng(lat, lng)}
              />
              <br />
              ...
              <input
                ...
                type="checkbox"
                id="1"
                name="Dumping down a storm drain"
                defaultChecked={this.state.type.includes(
              ...
              <input
                ...
                type="checkbox"
                id="2"
                name="Suspicious discharge from pipe into stream"
                defaultChecked={this.state.type.includes(
              ...
              <input
                ...
                type="checkbox"
                id="3"
                name="Water in stream is an unusual color"
                defaultChecked={this.state.type.includes(
              ...
              <input
                ...
                type="checkbox"
                id="4"
                name="Water in stream smells strange"
                defaultChecked={this.state.type.includes(
              ...
              <input
                ...
                type="checkbox"
                id="5"
                name="Suspicious suds or other substance floating on water"
                defaultChecked={this.state.type.includes(
              ...
              <input
                ...
                type="checkbox"
                id="6"
                name="Fish or other aquatic creatures appear to have died"
                defaultChecked={this.state.type.includes(
              ...
              <input
                ...
                id="7"
                name="other"
                defaultChecked={this.state.type.includes("other")}
              />
              ...
              />
              <br />
              <label htmlFor="water-body">
                Describe the creek or body of water affected:
              </label>
              <br />
              <input
                type="text"
              ...
              <br />
              <label htmlFor="water-body">
                Please add any details that might help a responder locate the
                site to take a sample:
              </label>
              <br />
              <textarea
                id="details"
              ...
              <br />
              {this.props.editMode ? (
                <button onClick={(e) => this.handleUpdateReport(e)}>
                  Done Editing
                </button>
              ) : (
                <button
